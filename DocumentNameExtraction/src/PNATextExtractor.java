 ...
 * @author Heidi Jauhiainen, University of Helsinki
 ...
 A script for extracting the document names from the text files found for printing the Prosopography of the Neo-Assyrian Empire volumes I/1- III/1.
...
public class PNATextExtractor {
     ...
     * 1 = path and name of file with concordance list
     * 2 = path and name of file with synonymous document names
    ...
    public static void main(String[] args) throws IOException {
        ...
        //read our own concordance list
        concords = readConcordances(args[1]);
